...
export class RestructureSpacemanWsTable1734020000000 implements MigrationInterface {
  name = 'RestructureSpacemanWsTable1734020000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Crear nueva tabla con el orden correcto de columnas
    await queryRunner.query(`
      CREATE TABLE "spaceman_ws" (
        "id" SERIAL NOT NULL,
        "game_id" integer NOT NULL,
        "bookmaker_id" integer NOT NULL,
        "url_sessionid" character varying,
